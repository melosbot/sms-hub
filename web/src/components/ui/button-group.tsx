...
function ButtonGroupSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "relative self-stretch border-0 bg-input data-horizontal:mx-px data-horizontal:h-px data-horizontal:w-auto data-vertical:my-px data-vertical:w-px data-vertical:h-auto",
        className
      )}
      {...props}
    />
